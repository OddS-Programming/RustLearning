//Движок вывода типов весьма умён.
// Он делает куда больше, чем просто смотрит на тип r-value при инициализации.
...
// Ну мы уже это поняли, спасибо, повторение мать учения
pub fn inference(){
    ...
    //  если его не напоить типом данных в силу физиологических особенностей он разрыдается
